Insert into BIOMARKER_THRESHOLD
   (BIOMARKER_ID, GROUP_ID, SEX, AGE_LOWER_IN_MONTHS, AGE_UPPER_IN_MONTHS, 
    CONDITIONAL_INFO, THRESHOLD_TYPE, SOURCE, MATRIX, LOWER_THRESHOLD, 
    UPPER_THRESHOLD, COMMENTS)
 Values
   ('zinc', 'PSC', 'f', 60, 120, 
    'Morning (sample time <= 12:00), non fasting', 'deficiency', 'BOND (KING 2016)', 'Plasma or Serum', 0, 
    65, 'Lower');
Insert into BIOMARKER_THRESHOLD
   (BIOMARKER_ID, GROUP_ID, SEX, AGE_LOWER_IN_MONTHS, AGE_UPPER_IN_MONTHS, 
    CONDITIONAL_INFO, THRESHOLD_TYPE, SOURCE, MATRIX, LOWER_THRESHOLD, 
...
Insert into BIOMARKER_THRESHOLD
 ...
 Values
   ('zinc', 'SAC', 'f', 132, 168, 
    'Morning (sample time <= 12:00), fasting', 'deficiency', 'BOND (KING 2016)', 'Plasma or Serum', 0, 
    70, 'Lower');
Insert into BIOMARKER_THRESHOLD
   (BIOMARKER_ID, GROUP_ID, SEX, AGE_LOWER_IN_MONTHS, AGE_UPPER_IN_MONTHS, 
    CONDITIONAL_INFO, THRESHOLD_TYPE, SOURCE, MATRIX, LOWER_THRESHOLD, 
...
Insert into BIOMARKER_THRESHOLD
 ...
 Values
   ('zinc', 'PSC', 'f', 60, 120, 
    'After midday (sample time >12:00)', 'deficiency', 'BOND (KING 2016)', 'Plasma or Serum', 0, 
    57, 'Lower');
Insert into BIOMARKER_THRESHOLD
   (BIOMARKER_ID, GROUP_ID, SEX, AGE_LOWER_IN_MONTHS, AGE_UPPER_IN_MONTHS, 
    CONDITIONAL_INFO, THRESHOLD_TYPE, SOURCE, MATRIX, LOWER_THRESHOLD, 
...
Insert into BIOMARKER_THRESHOLD
 ...
 Values
   ('haemoglobin', 'MEN', 'm', 0, NULL, 
    'must have been adjusted for altitude and smoking', 'deficiency - mild', 'WHO, 2011', 'Whole blood', 110, 
    129, 'lower, to define mild anemia');
Insert into BIOMARKER_THRESHOLD
   (BIOMARKER_ID, GROUP_ID, SEX, AGE_LOWER_IN_MONTHS, AGE_UPPER_IN_MONTHS, 
    CONDITIONAL_INFO, THRESHOLD_TYPE, SOURCE, MATRIX, LOWER_THRESHOLD, 
    UPPER_THRESHOLD, COMMENTS)
