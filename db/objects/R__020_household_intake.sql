...
--    , fct_used AS fct_source_id --TODO: we need to figure out how to carry forward the "FCT used" data to the other views and, ultmiately, the API
    , 1 AS fct_source_id --TODO: we need to figure out how to carry forward the "FCT used" data to the other views and, ultmiately, the API
...
WHERE (aggregation_area.type='admin' AND aggregation_area.admin_level=1) or aggregation_area.type='country'
