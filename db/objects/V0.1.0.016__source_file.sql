...
COMMENT ON COLUMN source_file.created_date   IS 'Date when file created';
COMMENT ON COLUMN source_file.notes          IS 'Notes about file preparation, considerations, assumptions etc. might include notes about which data were excluded from the file, and why';
