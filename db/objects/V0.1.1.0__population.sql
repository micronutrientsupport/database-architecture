...
create TABLE households_subnational_summary (
	id                          integer primary key GENERATED BY DEFAULT AS IDENTITY,
	country_id					text REFERENCES country(id),
	aggregation_area_id			text REFERENCES aggregation_area (gid),
	average_hh_size				numeric,
	households_2021				float8,
	households_2022				float8,
	households_2023				float8,
	households_2024				float8,
	households_2025				float8,
	households_2026				float8,
	households_2027				float8,
	households_2028				float8,
	households_2029				float8,
	households_2030				float8,
	households_2031				float8,
	households_2032				float8,
	households_2033				float8,
	households_2034				float8,
	households_2035				float8,
	source						text
);
...
select 
	...
	aa."name", 
	aa.admin_level, 
	hss.households_2021 as population_2021,
	hss.households_2022 as population_2022,
	hss.households_2023 as population_2023,
	hss.households_2024 as population_2024,
	hss.households_2025 as population_2025,
	hss.households_2026 as population_2026,
	hss.households_2027 as population_2027,
	hss.households_2028 as population_2028,
	hss.households_2029 as population_2029,
	hss.households_2030 as population_2030,
	hss.households_2031 as population_2031,
	hss.households_2032 as population_2032,
	hss.households_2033 as population_2033,
	hss.households_2034 as population_2034,
	hss.households_2035 as population_2035,
	hss.source
	
from households_subnational_summary hss 
join aggregation_area aa ON aa.gid = hss.aggregation_area_id 
order by hss.country_id, aa.admin_level, aa."name";