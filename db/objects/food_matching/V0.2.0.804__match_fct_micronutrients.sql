...
BEGIN
		...
		RAISE NOTICE 'Creating distinct_fct_list table...%', timeofday();
	...
	RAISE NOTICE 'Creating fct_list_food_compostion table...%', timeofday();
	...
	-- RAISE NOTICE 'Creating country_fct_list table...%', timeofday();
	...
	-- drop and recreate household_fct_list table
	-- RAISE NOTICE 'Creating household_fct_list table...%', timeofday();
