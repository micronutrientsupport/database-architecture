...
COMMENT on column household.subregion_id          IS 'ID of the sub-region where this household is located. Will be accurate, as sub-regions do not pose a privacy risk. Will be populated either directly, from survey data, or from lat/lon data supplied about the household';
