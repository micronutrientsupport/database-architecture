...
select intervention_id, header1, header2, max(max_row) as max_row, json_agg(data) as data from (
	select intervention_id, header1, header2, max_row, json_build_object(
		...
		'year0Overriden', (expanded->>'year0Overriden')::boolean,
