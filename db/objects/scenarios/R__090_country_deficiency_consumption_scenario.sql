create or replace function create_country_deficiency_afe_consumption_scenario(_country_consumption_source_id numeric, _food_genus text[], _field text, _new_value numeric[])
...
BEGIN
  return QUERY
    ...
    (
        ...
        from create_country_intake_consumption_scenario(_country_consumption_source_id, _food_genus, _field, _new_value) ci
