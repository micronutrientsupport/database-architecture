create or replace function create_country_deficiency_afe_consumption_scenario(_compositionDataId numeric, _consumptionDataId numeric, _food_genus text[], _field text, _new_value numeric[])
...
BEGIN
  return QUERY
    ...
    (
        ...
        from create_country_intake_consumption_scenario(_compositionDataId, _consumptionDataId, _food_genus, _field, _new_value) ci
...
--select * from create_country_deficiency_afe_consumption_scenario(1, ARRAY ['23161.02.01', '23110.02', '23161.01.01'], 'Mg'::text, ARRAY [5000, 75, 20]);
